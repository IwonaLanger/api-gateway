...
- APIRule now supports wildcard hostnames (for example, `*.example.com`) to route traffic from all matching subdomains with a single rule. See [PR #2620](https://github.com/kyma-project/api-gateway/pull/2620).
